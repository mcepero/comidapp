...
public class EliminarProducto extends javax.swing.JFrame {
     ...
     */
    public EliminarProducto(JPanelProducto producto) {
    ...
    private void jButtonSiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSiActionPerformed
        try {
            SocketHandler.getOut().println(Mensajes.PETICION_ELIMINAR_PRODUCTO + "--" + producto.getId());
            if (SocketHandler.getIn().readLine().equals(Mensajes.PETICION_ELIMINAR_PRODUCTO_CORRECTO)) {
